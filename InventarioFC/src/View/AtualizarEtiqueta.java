 ...
 *
 */
public class AtualizarEtiqueta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtualizarEtiqueta frame = new AtualizarEtiqueta();
	 ...
	 * Create the frame.
	 */
	public AtualizarEtiqueta() {
		setLocationRelativeTo(null);
		setTitle("Atualizar Etiqueta");
		...
		JButton btnInserirProdutoMp = new JButton("Atualizar Etiqueta");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(prod.codigo.isEmpty()) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "A Etiqueta "+prod.codigo+" foi alterada com sucesso!");
						dispose();
		...
		comboBoxAtt.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				try {
					...
					txtDescricao.setText("Nenhuma etiqueta selecionada");
				}
			}
		});
