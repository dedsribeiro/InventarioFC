...
public class Etiqueta extends JFrame {
	...
	public Etiqueta() {
		...
		btnAdiciona.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					" etiquetas no estoque de "+comboBox.getSelectedItem().toString()+" ?");
					if(resultado == JOptionPane.YES_OPTION){
						DAOEtiqueta dpt = new DAOEtiqueta();
		...
		JMenu mnAdministrarProdutos = new JMenu("Administrar Etiquetas");
		...
		mntmInserir.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				InserirEtiqueta ins = new InserirEtiqueta();
				ins.setVisible(true);
		...
		mntmAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AtualizarEtiqueta att = new AtualizarEtiqueta();
				att.setVisible(true);
		...
		comboBox.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				try {
					...
					lblNewLabel.setText("Quantidade em estoque: "+Integer.toString(dpt.busca_quantidade(comboBox.getSelectedItem().toString()))+" etiquetas");
	...
	{			
	    ...
	    String delItem = (String) JOptionPane.showInputDialog(frame, 
	        ...
	        resultados[0]);
	    	if(delItem != null) {
	    		int resp = JOptionPane.showConfirmDialog(null, "A Etiqueta será deletada!\nConfirma a deleção do item selecionado?");	
	...
	{		
	    ...
	    JFrame frame = new JFrame("Pesquisa de etiqueta");
	    String delItem = (String) JOptionPane.showInputDialog(frame, 
	        "Qual etiqueta deseja pesquisar?",
	        "Pesquisar Etiqueta",
	        JOptionPane.QUESTION_MESSAGE, 
	        null, 
	        resultados, 
