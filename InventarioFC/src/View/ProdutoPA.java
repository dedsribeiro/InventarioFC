 ...
 *
 */
public class ProdutoPA extends JFrame {
	...
	public ProdutoPA() {
		...
		JButton btnTranforma = new JButton("Despachar de P.A.");
		btnTranforma.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					int resultado = JOptionPane.showConfirmDialog(null, "Despachar "+txtQuantidade.getText()+
					" peças de "+comboBox.getSelectedItem().toString()+" ?");
		...
		mntmAtualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				AtualizarPA att = new AtualizarPA();
				att.setVisible(true);
