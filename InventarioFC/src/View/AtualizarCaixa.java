 ...
 *
 */
public class AtualizarCaixa extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AtualizarCaixa frame = new AtualizarCaixa();
	 ...
	 * Create the frame.
	 */
	public AtualizarCaixa() {
		setLocationRelativeTo(null);
		setTitle("Atualizar Caixa");
		...
		JButton btnInserirProdutoMp = new JButton("Atualizar Caixa");
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(prod.codigo.isEmpty()) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, "A Caixa "+prod.codigo+" foi alterada com sucesso!");
						dispose();
		...
		comboBoxAtt.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent arg0) {
				...
				try {
					...
					txtDescricao.setText("Nenhuma caixa selecionada");
				}
			}
		});
