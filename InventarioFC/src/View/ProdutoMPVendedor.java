 ...
 *
 */
public class ProdutoMPVendedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProdutoMPVendedor frame = new ProdutoMPVendedor();
	...
	public ProdutoMPVendedor() {
		...
		comboBox.setBounds(367, 124, 181, 23);
		...
		JButton btnNewButton_1 = new JButton("Pesquisar Produto M.P.");
		...
		btnNewButton_1.setBounds(367, 158, 181, 29);
